...
${'document_srl41_argument'} = new ConditionArgument('document_srl', $args->document_srl, 'in');
...
,new ConditionWithArgument('`extra_vars`.`document_srl`',$document_srl41_argument,"in", 'and')
