...
new ConditionWithArgument('`is_admin`',$is_admin14_argument,"equal")
,new ConditionWithArgument('`denied`',$is_denied15_argument,"equal", 'and')
,new ConditionWithArgument('`member_srl`',$member_srls16_argument,"in", 'and')))
,new ConditionGroup(array(
new ConditionWithArgument('`user_id`',$s_user_id17_argument,"like")
...
,new ConditionWithArgument('`nick_name`',$html_nick_name20_argument,"like", 'or')
,new ConditionWithArgument('`email_address`',$s_email_address21_argument,"like", 'or')
,new ConditionWithArgument('`birthday`',$s_birthday22_argument,"like", 'or')
,new ConditionWithArgument('`extra_vars`',$s_extra_vars23_argument,"like", 'or')
,new ConditionWithArgument('`regdate`',$s_regdate24_argument,"like_prefix", 'or')
,new ConditionWithArgument('`last_login`',$s_last_login25_argument,"like_prefix", 'or')
